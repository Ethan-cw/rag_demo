...
class LlmModel:
    ...
    def _chat(self, query: str, history: List[Tuple[str, str]] = None, max_length: int = 2048, num_beams=1,
        ...
        chat_result = self.model.chat(self.tokenizer, query, history, max_length, num_beams, do_sample, top_p,
                                      temperature, logits_processor, **kwargs)
        return chat_result
...
if __name__ == "__main__":
    path = "D:\\pyproject\\ChatGLM2-6B\\data\\THUDM\\chatglm2-6b-int4"
