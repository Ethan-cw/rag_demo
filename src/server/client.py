...
def cal_time_result(time_list):
    ...
    print("tp50:{:.4f}ms, tp90:{:.4f}ms,tp95:{:.4f}ms,tp99:{:.4f}ms".format(tp[0] * 1000, tp[1] * 1000, tp[2] * 1000,
                                                                            tp[3] * 1000))
...
# response = requests.post("http://127.0.0.1:9090/a", json.dumps({"query": "你好啊"}))
