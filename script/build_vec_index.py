...
if __name__ == "__main__":
    # 0. 必要配置
    # VEC_MODEL_PATH = "./huggingface/models/simcse-chinese-roberta-wwm-ext" simcse
    VEC_MODEL_PATH = "D:\\pyproject\\LLM\\m3e-base"

    # https://github.com/brightmart/nlp_chinese_corpus中的百科类问答json版数据
    SOURCE_INDEX_DATA_PATH = "\\data\\baike_qa2019\\baike_qa_train.json"
    ...
    # print(VectorizeModel(VEC_MODEL_PATH, DEVICE).predict_vec("你好啊"))
